defmodule Basis.LLM.ScriptedProvider do
  ...
  def complete(%Basis.LLM.ContextPacket{} = packet, emit) when is_function(emit, 1) do
    ...
    {:ok,
     %{
       ...
       build_shape: scripted_build_shape(packet),
  ...
  defp scripted_build_shape(%{lens_role: "root_orientation_lens"} = packet) do
    %{
      "title" => "Scripted root build shape",
      "source" => "Root Orientation #{packet.job_id}",
      "boundary" => "proposal state, not accepted Basis state",
      "nodes" => [
        %{
          "id" => "source",
          "title" => "Loaded Source",
          "body" => packet.source_path,
          "kind" => "source"
        },
        %{
          "id" => "claim",
          "title" => "Reducer Claim",
          "body" => "source text is read as reducible dimensions",
          "kind" => "claim"
        },
        %{
          "id" => "state",
          "title" => "Candidate Basis",
          "body" => "proposal records stay reviewable",
          "kind" => "records"
        },
        %{
          "id" => "impact",
          "title" => "Projection Pressure",
          "body" => Enum.join(packet.target_projections, ", "),
          "kind" => "targets"
        }
      ],
      "edges" => [
      ...
      "support" => [
        %{
          "title" => "Thread source",
          "body" => "Generated by root_orientation_lens on spec load.",
          "kind" => "support"
        },
        %{
          "title" => "Acceptance gate",
          "body" => "Durable state still needs an acceptance record.",
          "kind" => "gate"
        }
      ]
    }
  ...
  defp scripted_build_shape(_packet), do: nil
