You are judging Spec Gym projection cycle `aws-architecture__architecture-to-spec` for round-001.

Inputs the runner must attach:
- original dataified-spec.json
- original claim-lattice.json
- intermediate artifact from `aws-architecture`: architecture.md
- returned spec draft from `architecture-to-spec`: spec-draft.md
